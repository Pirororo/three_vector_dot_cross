      ...
      super();
        ...
        for (let i = 0; i < xMax; i++) {
            // for (let j = 0; j < zMax; j++) {
                ...
                this.meshList[k].position.x = 40 * Math.sin(50*i*Math.PI/180);
                this.meshList[k].position.y = i*15 -(xMax*15/2);
                this.meshList[k].position.z = 40 * Math.cos(50*i*Math.PI/180);
